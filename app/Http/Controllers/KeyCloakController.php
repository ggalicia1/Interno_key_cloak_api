...
class KeyCloakController extends Controller
{
    ...
    public function users(Request $request)
    {
        try {
            ...
            $realm = $request->realm ? $request->realm : 'Portal-Interno';
    ...
    public function userById(Request $request)
    {
        try {
            ...
            $user_id = $request->realm ? $request->user_id : null;

            if($realm == null || $user_id == null){
                return response()->json([
                'status' => false,
            ...
            $user = KeycloakAdmin::users()->get($realm, $user_id);
            return response()->json([
                'status' => true,
                'message' => 'Operación exitosa',
                'data' => $user
